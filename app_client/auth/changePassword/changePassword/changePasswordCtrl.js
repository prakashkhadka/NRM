...
(function(){
    angular
        .module("roomApp")
        .controller("changePasswordCtrl", ['$scope', '$location', '$http', 'authentication', '$anchorScroll', '$timeout', changePasswordCtrl]);
    //changePasswordCtrl.$inject = ['$scope', '$location', '$http', 'authentication', '$anchorScroll', '$timeout'];
